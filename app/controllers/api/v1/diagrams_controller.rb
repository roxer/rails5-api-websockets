class Api::V1::DiagramsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @api_v1_diagram.save
        format.html do
          redirect_to @api_v1_diagram, notice: 'Diagram was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @api_v1_diagram.update(api_v1_diagram_params)
        format.html do
          redirect_to @api_v1_diagram, notice: 'Diagram was successfully updated.'
        end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
        redirect_to api_v1_diagrams_url, notice: 'Diagram was successfully destroyed.'
      end
