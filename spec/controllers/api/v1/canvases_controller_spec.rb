...
RSpec.describe Api::V1::CanvasesController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to eq(canvas)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to be_a_new(Api::V1::Canvas)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created api_v1 as @api_v1" do
        post :create, {:api_v1 => valid_attributes}, valid_session
        expect(assigns(:api_v1)).to be_a(Api::V1::Canvas)
        expect(assigns(:api_v1)).to be_persisted
      end

      it "redirects to the created api_v1" do
        post :create, {:api_v1 => valid_attributes}, valid_session
        expect(response).to redirect_to(Api::V1::Canvas.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested api_v1" do
        canvas = Api::V1::Canvas.create! valid_attributes
        put :update, {:id => canvas.to_param, :api_v1 => new_attributes}, valid_session
        canvas.reload
      ...
      it "assigns the requested api_v1 as @api_v1" do
        canvas = Api::V1::Canvas.create! valid_attributes
        put :update, {:id => canvas.to_param, :api_v1 => valid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(canvas)
      end
      ...
      it "redirects to the api_v1" do
        canvas = Api::V1::Canvas.create! valid_attributes
        put :update, {:id => canvas.to_param, :api_v1 => valid_attributes}, valid_session
        expect(response).to redirect_to(canvas)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the api_v1 as @api_v1" do
        canvas = Api::V1::Canvas.create! valid_attributes
        put :update, {:id => canvas.to_param, :api_v1 => invalid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(canvas)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the api_v1_canvases list" do
      canvas = Api::V1::Canvas.create! valid_attributes
      delete :destroy, {:id => canvas.to_param}, valid_session
      expect(response).to redirect_to(api_v1_canvases_url)
    end
  end
